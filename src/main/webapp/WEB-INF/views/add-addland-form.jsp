...
<body >
 <div class="container">
			...
			<form:form action="/assest/addasset" method="post" enctype="multipart/form-data" modelAttribute="addassest">
			<h1>Asset Form</h1>
				<div class="row">
                <div class="col-25">
					<label for="id">Asset Id</label>
					 ...
					 <div class="col-75">
						<form:input path="id" title="Asset ID only Contains 4 Numbers" pattern="[0-9]{4}" required="true"/>
					</div>
				 </div> 
				<br>
                ...
                <div class="col-25">
					...
					<div class="col-75">
						<form:input path="usersId" title="user ID only Contains 4 Numbers" pattern="[0-9]{4}" required="true"/>
					</div>
				</div>
				<br>
                ...
                <div class="col-25">
					...
					<div class="col-75">
						<form:input path="length" id="length" title="enter only two digit" pattern="[0-9]{2}" required="true" onchange="squarefeetCalucation();"/>
					</div>
				</div>
				<br>
                ...
                <div class="col-25">
					...
					<div class="col-75">
						<form:input path="breadth" id="breadth" title="LandBreadth should have atleast 2 digits" pattern="[0-9]{2}" onchange="squarefeetCalucation();" required="true"/>
					</div>
				</div>
				<br>
				<div class="row">
                <div class="col-25">
					...
					<div class="col-75">
						<form:input path="squareFeet" id="squareFeet" title="pattaNumber should have 4 To 7digits" pattern="[0-9]{4,7}" onchange="squarefeetCalucation(this.form);" required="true"/>
					</div>
				</div>
				<br>
                ...
                <div class="col-25">
					...
					<div class="col-75">
						<form:input path="surveyNumber" title="surveyNumber should have  2 digits" pattern="[0-9]{2}" required="true"/>
					</div>
				</div>
				<br>
                ...
                <div class="col-25">
					...
					<div class="col-75">
						<form:input path="pattaNumber" title="pattaNumber should have  2 digits" pattern="[0-9]{2}" required="true" />
					</div>
				</div>
				<br>
                ...
                <div class="col-25">
					...
					<div class="col-75">
						<form:input path="contactNumber"   title="PhoneNumber should have atleast 10 digits"
                ...
                <div class="col-25">
                    ...
                    <div class="col-75">
                        <form:select path="assestType" class="text-box" placeholder="AssetType" title="Name can't be empty" required="true">
                ...
                <div class="col-25">
					...
					<div class="col-75">
						<form:input path="price" title="Name can't be less than 5 to 7" pattern="[0-9]{5,7}" required="true"/>
					</div>
				</div>
				<br>
			<div class="row">
